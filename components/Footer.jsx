...
export default function Footer() {
  return (
    <footer className="bg-pollocks-black text-white w-full h-full lg:h-screen px-5 sm:px-8 lg:px-12">
      <div className="max-w-5xl mx-auto h-full flex flex-col justify-center py-12 sm:py-14 lg:py-10">
        {/* Final CTA */}
        <div className="mb-8 lg:mb-6 text-center">
          <h2 className="text-2xl sm:text-3xl lg:text-3xl font-bold mb-3 tracking-tight font-serif leading-tight">
        ...
        <div className="border-t border-white/10 pt-6 lg:pt-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 mb-6 lg:mb-4">
            {/* Brand & Contact */}
            <div className="sm:col-span-2">
              ...
              <p className="text-gray-400 max-w-xs mb-3 text-sm leading-relaxed">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-bold mb-3 text-sm font-serif">Quick Links</h4>
            ...
            {/* Branches */}
            <div>
              <h4 className="font-bold mb-3 text-sm font-serif">Our Branches</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
          ...
          {/* Bottom Bar */}
          <div className="flex flex-col sm:flex-row justify-between items-center pt-4 border-t border-white/10 text-xs text-gray-500 gap-3">
