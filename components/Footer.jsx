        ...
        <div className="border-t border-white/10 pt-10 sm:pt-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-8 mb-10">
            ...
            <div className="sm:col-span-2">
              ...
              <p className="text-gray-400 max-w-xs mb-5 text-sm leading-relaxed">
                Established in 1966, providing quality CBSE education from Pre-Nursery to 10th Standard in Visakhapatnam.
              </p>
              
              {/* Contact Info */}
              <div className="space-y-3 mb-5">
                <a href="tel:+919391401900" className="flex items-center gap-3 text-gray-400 hover:text-pollocks-blue transition-colors text-sm">
                  <Phone className="w-4 h-4" />
                  <span>+91 93914 01900</span>
                </a>
                <a href="mailto:info@pollocks.in" className="flex items-center gap-3 text-gray-400 hover:text-pollocks-blue transition-colors text-sm">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="font-bold mb-5 text-sm font-serif">Quick Links</h4>
            ...
            {/* Branches */}
            <div>
              <h4 className="font-bold mb-5 text-sm font-serif">Our Branches</h4>
              <ul className="space-y-3 text-gray-400 text-sm">
